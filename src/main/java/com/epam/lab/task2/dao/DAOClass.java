...
public class DAOClass {
    ...
    public ResultSet getRecordById(String tableName, int id, String s) throws SQLException {
        return connection.createStatement().executeQuery("SELECT * FROM " + tableName + " WHERE " + s + "=" + id);
    }
